...
./mvnw clean package
rm resource-gist/springboot-concourse-0.0.5-SNAPSHOT.jar
cp code/target/springboot-concourse-0.0.5-SNAPSHOT.jar resource-gist/springboot-concourse-0.0.5-SNAPSHOT.jar
cd resource-gist
